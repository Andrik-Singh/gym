      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-3xl shadow-xl p-12 text-center relative overflow-hidden">
          ...
          <div className="relative mb-6 inline-block">
            <div className="w-20 h-20 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-2xl flex items-center justify-center transform rotate-6 transition-transform hover:rotate-12 duration-300">
              <UtensilsCrossed className="w-10 h-10 text-emerald-600 -rotate-6" />
            </div>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-3">
            Your Meal Collection Awaits
          </h2>
          <p className="text-gray-500 mb-8 leading-relaxed">
            Start building your personalized meal library. Save your favorite
            recipes and create delicious meal plans in minutes.
          </p>
            ...
            <div className="flex items-start gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 leading-relaxed">
                  Add meals you love to quickly generate weekly meal plans
        ...
        <div className="mt-6 grid grid-cols-3 gap-3">
          <div className="bg-white rounded-xl p-4 shadow-sm text-center">
            ...
            <p className="text-xs text-gray-600 font-medium">Easy Recipes</p>
          </div>
          <div className="bg-white rounded-xl p-4 shadow-sm text-center">
            <div className="text-2xl mb-2">📅</div>
